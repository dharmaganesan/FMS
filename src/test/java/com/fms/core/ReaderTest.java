...
public class ReaderTest {
    ...
    public static final Supplier<Reader<Datastore, Supplier<List<String>>>> inactive = ReaderTest::inactive;
    public static final Function<Supplier<List<String>>, Reader<EmailServer,
        Runnable>> emailInactive = ReaderTest::emailInactive;
